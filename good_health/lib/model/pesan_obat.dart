...
final uri = Api.endpoint('/pesan_obat/index.php').replace(queryParameters: {
...
Future pesanObatCreate(PesanObat pesanObat) async {
  ...
  try {
    final uri = Api.endpoint('/pesan_obat/create.php');
...
Future deletePesanObat(id) async {
  ...
  final uri = Api.endpoint('/pesan_obat/delete.php').replace(queryParameters: {
  'id': id.toString(),
});
...
Future updatePesanObat(id) async {
  ...
  final uri = Api.endpoint('/pesan_obat/update.php').replace(queryParameters: {
  'id': id.toString(),
});
